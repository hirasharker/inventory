<div class="row">
        <div class="col-md-12">
            <h1 class="page-header">
                Warehouse Inventory Report <small>Individual Item</small>
            </h1>
        </div>
    </div> 
     <!-- /. ROW  -->
...
<script>
        $( "#search" ).click(function() {
          // alert( "Handler for .click() called." );
            ...
            $.ajax({
                url: '<?php echo base_url();?>inventory/generate_warehouse_inventory_detail',
                type:'POST',
                dataType: 'json',
                data: {warehouse_id : warehouseId, from_date : fromDate, to_date : toDate},
